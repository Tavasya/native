        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/company/nativespeaking" 
                className="text-brand-primary hover:text-brand-primary/80"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span className="sr-only">LinkedIn</span>
                <div className="w-8 h-8 rounded-full bg-brand-primary/10 hover:bg-brand-primary/20 flex items-center justify-center transition-colors">
              ...
              <a 
                href="https://www.instagram.com/native.speaking" 
                className="text-brand-primary hover:text-brand-primary/80"
                target="_blank"
                rel="noopener noreferrer"
              >
