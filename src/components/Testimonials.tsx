  ...
  return (
    ...
    >
      <CardContent className="p-6 flex flex-col h-full">
        <div className="mb-4">
          <Quote className="w-8 h-8 text-brand-primary opacity-70" />
        </div>
      ...
      <div className="container bg-inherit">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-xl text-gray-600">
            Join hundreds of IELTS teachers who are saving time and improving student outcomes.
          </p>
        </div>
          ...
          <div className="overflow-hidden" ref={viewportRef}>
            <div className="flex">
              {testimonials.map((testimonial, index) => (
                <div 
                  key={index} 
                  className={`flex-[0_0_100%] md:flex-[0_0_calc(100%/${visibleSlides})] px-2 md:px-4`}
                >
                  <Testimonial
